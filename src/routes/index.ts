...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsUsersController_getUsers: Record<string, TsoaRoute.ParameterSchema> = {
                ...
                sort: {"in":"query","name":"sort","required":true,"dataType":"string"},
        };
        app.get('/api/users',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUsersController_patchUser: Record<string, TsoaRoute.ParameterSchema> = {
                userId: {"in":"path","name":"userId","required":true,"dataType":"string"},
                user: {"in":"body","name":"user","required":true,"dataType":"any"},
        };
        app.patch('/api/users/:userId',
            ...
            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsUsersController_patchUser, request, response });
